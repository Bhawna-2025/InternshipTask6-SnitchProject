...
const Footer = () => {
  return (
    <div className="mt-15 bg-[#F8F1E9] text-black w-full min-h-[50vh] py-10 px-10 flex flex-col gap-8 mb-10">
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-2">
          <div>
            ...
            <a href="#">
              <p className="text-[12px] text-gray-800">
                Rover Wrap Black Bracelet
              </p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Bold Swirl Bracelet</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">
          ...
          <div>
            <a href="#">
              <p className="text-[12px] text-gray-800">
                EternaWrap Black Bracelet
              </p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Bar of Luxe Chain</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Solid Block SS Chain</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Rattle Square Chain</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Mafia SS Chain</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Grey Cuboid SS Chain</p>
            </a>
          </div>
          ...
          <div>
            ...
            <a href="#">
              <p className="text-[12px] text-gray-800">Rogue Bullet Pendant</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">
          ...
          <div>
            ...
            <a href="#">
              <p className="text-[12px] text-gray-800">Hexa Beads Bracelet</p>
            </a>
            <a href="#">
              <p className="text-[12px] text-gray-800">Black Cuboid SS Chain</p>
            </a>
          </div>
        </div>
      </div>
