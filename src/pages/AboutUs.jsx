  ...
  return (
    <div>
      ...
      <div className="pt-24 pb-10 md:mx-30 mx-5">
        ...
        <p className="text-neutral-700 md:mt-8 mt-5 text-sm mx-20">
        ...
        <p className="text-neutral-700 md:mt-4 mt-2 text-sm mx-20">
        ...
        <p className="text-neutral-800 md:mt-4 mt-2 text-lg mx-20">
